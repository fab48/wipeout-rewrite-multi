...
typedef enum {
	...
	// Second gamepad; same layout as the first one, INPUT_GAMEPAD2_OFFSET apart
	INPUT_GAMEPAD2_A = 139,
	INPUT_GAMEPAD2_Y = 140,
	INPUT_GAMEPAD2_B = 141,
	INPUT_GAMEPAD2_X = 142,
	INPUT_GAMEPAD2_L_SHOULDER = 143,
	INPUT_GAMEPAD2_R_SHOULDER = 144,
	INPUT_GAMEPAD2_L_TRIGGER = 145,
	INPUT_GAMEPAD2_R_TRIGGER = 146,
	INPUT_GAMEPAD2_SELECT = 147,
	INPUT_GAMEPAD2_START = 148,
	INPUT_GAMEPAD2_L_STICK_PRESS = 149,
	INPUT_GAMEPAD2_R_STICK_PRESS = 150,
	INPUT_GAMEPAD2_DPAD_UP = 151,
	INPUT_GAMEPAD2_DPAD_DOWN = 152,
	INPUT_GAMEPAD2_DPAD_LEFT = 153,
	INPUT_GAMEPAD2_DPAD_RIGHT = 154,
	INPUT_GAMEPAD2_HOME = 155,
	INPUT_GAMEPAD2_L_STICK_UP = 156,
	INPUT_GAMEPAD2_L_STICK_DOWN = 157,
	INPUT_GAMEPAD2_L_STICK_LEFT = 158,
	INPUT_GAMEPAD2_L_STICK_RIGHT = 159,
	INPUT_GAMEPAD2_R_STICK_UP = 160,
	INPUT_GAMEPAD2_R_STICK_DOWN = 161,
	INPUT_GAMEPAD2_R_STICK_LEFT = 162,
	INPUT_GAMEPAD2_R_STICK_RIGHT = 163,

	INPUT_BUTTON_MAX = 164
} button_t;

#define INPUT_GAMEPAD2_OFFSET (INPUT_GAMEPAD2_A - INPUT_GAMEPAD_A)
